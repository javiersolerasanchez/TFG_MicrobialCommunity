...
# Modified: 12/02/2020 by Javier Solera Sánchez
...
def runn(md = ""):
    ...
    mod_dir = "/home/javi/Documentos/Root_sin_P/" #Directorio donde está el modelo
    ...
    for pert in range(3): # BGJ: 2019.11.08 #SI QUEREMOS CAMBIAR EL NÚMERO DE PERTURBACIONES POR SIMULACIÓN.
